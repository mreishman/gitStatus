...
<script type="text/javascript"> 
	...
	$( document ).ready(function()
	{
		...
		{
			updateText("No update is currently available for Monitor.");
	...
	{
		document.getElementById('innerSettingsText').innerHTML = "<p>An error occured while trying to update gitStatus. </p>";
	}
	...
	function finishUpdateOneHundredCheck()
	{
		...
		var urlForSend = "../core/php/update/verifyVersionInstallComplete.php";
		var dataSend = {};
		$.ajax({
			url: urlForSend,
			dataType: "json",
