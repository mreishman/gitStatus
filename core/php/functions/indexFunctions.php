...
function generateWindow($data = array(), $pollType)
{
	...
	$blockHTML .= "			<img onclick=\"singleSwitchToExpandView('".$keyNoSpace."');\" id=\"".$keyNoSpace."DownArrow\" style=\"cursor: pointer; height: 18px;\" src=\"core/img/downarrow.png\">";
	$blockHTML .= "			<img onclick=\"singleSwitchToStandardView('".$keyNoSpace."');\" id=\"".$keyNoSpace."UpArrow\" style=\"cursor: pointer; height: 18px; \" src=\"core/img/uparrow.png\">";
